...
efficientnet_model = EfficientNetB0(weights=None, input_shape=(32, 32, 3), classes=43)
efficientnet_model.compile(optimizer='adam', loss='categorical_crossentropy', metrics=['accuracy'])
history = efficientnet_model.fit(x_train, y_train, batch_size=64, epochs=10, validation_data=(x_test, y_test))
...
efficientnet_model.save('traffic_sign_classifier_efficientnet.h5')
