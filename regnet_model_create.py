...
regnet_model = RegNetX002(weights=None, input_shape=(32, 32, 3), classes=43)
regnet_model.compile(optimizer='adam', loss='categorical_crossentropy', metrics=['accuracy'])
history = regnet_model.fit(x_train, y_train, batch_size=64, epochs=7, validation_data=(x_test, y_test))
...
predictions = regnet_model.predict(x_test)
...
regnet_model.save('traffic_sign_classifier_regnet_epoch7.h5')
